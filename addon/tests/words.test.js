...
test("markWords never colours a particle, whatever the deck holds", () => {
  // Yomitan looks particles up like any word, so a deck can hold は, の or のは; painting the は of
  // every line would say nothing about the viewer's words.
  ...
  // The の fusions and かも, which ICU cuts as words of their own, are particles too.
